  ...
  useEffect(() => {
    ...
    class CommonClass {
      constructor() {
        ...
        this.container = null;
        this.renderer = null;
        // ── Simple manual clock using performance.now() ──
        // Avoids both THREE.Clock (deprecated) and THREE.Timer (inconsistent)
        this._lastTime = null;
      }
      init(container) {
      ...
      update() {
        ...
        this.delta = Math.min((now - this._lastTime) / 1000, 0.1);
        this._lastTime = now;
